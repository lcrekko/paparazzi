...
static struct image_t *object_detector(struct image_t *img, uint8_t filter) {
    ...
    global_filters[filter - 1].y_c = y_c_o_L;
    global_filters[filter - 1].updated = true;
    global_filters[filter - 2].color_count = right_orange_count;
    global_filters[filter - 2].x_c = x_c_o_R;
    global_filters[filter - 2].y_c = y_c_o_R;
    global_filters[filter - 2].updated = true;
    global_filters[filter - 3].color_count = left_green_count;
    global_filters[filter - 3].x_c = x_c_o_L;
    global_filters[filter - 3].y_c = y_c_o_L;
    global_filters[filter - 3].updated = true;
...
void color_object_detector_periodic(void) {
    ...
    if (local_filters[2].updated) {
        ...
        AbiSendMsgVISUAL_DETECTION(COLOR_OBJECT_DETECTION4_ID, local_filters[3].x_c, local_filters[3].y_c,
                                   0, 0, local_filters[3].color_count, 3);
        local_filters[3].updated = false;

    }
        if (local_filters[4].updated) {
        AbiSendMsgVISUAL_DETECTION(COLOR_OBJECT_DETECTION5_ID, local_filters[4].x_c, local_filters[4].y_c,
                                   0, 0, local_filters[4].color_count, 4);
